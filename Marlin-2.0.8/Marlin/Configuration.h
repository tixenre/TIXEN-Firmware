...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.08,  22.20 }
    #define DEFAULT_Ki_LIST {   1.76,   1.08 }
    #define DEFAULT_Kd_LIST { 69.37, 114.00 }
  #else
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 1600, 1627 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) *0.17)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) *0.83)  // Y point for Z homing
#endif
